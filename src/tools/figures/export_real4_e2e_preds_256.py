...
OUT = Path('/tmp/smile2_real4_e2e_preds_256')
...
crop = 256
# Use a flower-centered 256x256 real crop. Most legacy E2E baselines were
# trained/tested on 256 windows, and some wrappers break on larger real crops.
y0 = 200
x0 = 120
H0 = crop
W0 = crop
