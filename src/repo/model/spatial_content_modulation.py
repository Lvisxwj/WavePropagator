"""
spatial_content_modulation.py — Spatial-content modulation blocks

SpatialContentModulation follows the lightweight multiplicative channel-spatial modulation used in the public experiments.
...
class SpatialContentModulation(nn.Module):
